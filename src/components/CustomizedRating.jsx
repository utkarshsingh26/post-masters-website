...
export default function RatingsBlock() {
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 0 }}>
      ...
      <Stack alignItems="flex-start">
        <Rating name="advisor-rating" defaultValue={4} max={5} />
        <Typography variant="caption" sx={{ ml: 10 }}><b><i>– Thesis Advisor</i></b></Typography>
      </Stack>

      <Stack alignItems="flex-start">
        <Rating name="mayo-rating" defaultValue={5} max={5} />
        <Typography variant="caption" sx={{ ml: 10 }}><b><i>– Mayo Clinic Collaborators</i></b></Typography>
      </Stack>
